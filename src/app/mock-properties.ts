...
export const PROPERTIES: Property[] = [
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 1) },
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 2) },
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 3) },
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 4) },
];
