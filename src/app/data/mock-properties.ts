...
export const PROPERTIES: Property[] = [
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 1), imageSrc: '/assets/img/Heights.jpg' },
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 2), imageSrc: '/assets/img/Parkview.jpg'},
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 3), imageSrc: '/assets/img/Hilltop.jpg'},
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 4), imageSrc: '/assets/img/Shady.jpg'},
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 5), imageSrc: '/assets/img/Sunset.jpg'},
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 6), imageSrc: 'assets/img/Westwood.jpg'},
    ...
    reviews: REVIEWS.filter(r => r.propertyId === 7), imageSrc: 'assets/img/Cedarwood.jpg'},
